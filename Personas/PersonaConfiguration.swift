...
/// Keeps personality traits and prompt fragments outside of hardcoded response logic.
struct PersonaConfiguration: Sendable, Codable, Equatable {
    ...
    let traits: [String: String]          // e.g. ["tone": "calm", "style": "technical"]
    let preferredTemperature: Double      // hint for future AI providers
